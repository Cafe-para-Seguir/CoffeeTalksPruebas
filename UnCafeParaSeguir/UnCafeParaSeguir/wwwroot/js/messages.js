!(function (t) {
    ...
    10: function (t, e, n) {
        var r = n(1),
            ...
            u = function (t, e, n) {
                ...
                for (c in (g && (n = e), n))
                    (f = ((l = !d && x && void 0 !== x[c]) ? x : n)[c]), (p = m && l ? s(f, r) : h && "function" == typeof f ? s(Function.call, f) : f), x && a(x, c, f, t & u.U), b[c] != f && i(b, c, p), h && y[c] != f && (y[c] = f);
            };
        ...
        !(function () {
            ...
            document.querySelector("#message-reply").addEventListener("submit", function (n) {
                ...
                (r = s.value),
                    ...
                    (i = t.templates("#template-message").render({ name: "Laza Bogdan", avatar: "assets/images/people/110/guy-6.jpg", date: "just now", message: r })),
                    (a = document.createRange().createContextualFragment(i)),
                    o.appendChild(a),
                    (s.value = ""),
                    e();
            });
    ...
    363: function (t, e, n) {
        var r;
        n(61), n(45), n(364), n(42), n(46), n(72), n(365), n(74);
        var o = n(39);
        !(function (i, a) {
            var s = a.jQuery;
            "object" === o(e)
            ...
            var r,
                ...
                L = { "&": "&amp;", "<": "&lt;", ">": "&gt;", "\0": "&#0;", "'": "&#39;", '"': "&#34;", "`": "&#96;", "=": "&#61;" },
                U = { amp: "&", gt: ">", lt: "<" },
                J = "For #index in nested block use #getIndex().",
                B = {},
                z = t.jsrender,
                K = z && e && !e.render,
                H = {
                        ...
                        compile: function t(n, r, o, i) {
                            function a(r) {
                                ...
                                if ("" + r === r || (r.nodeType > 0 && (u = r))) {
                                    if (!u)
                                        if (/^\.\/[^\\:*?"<>]*$/.test(r)) (s = f[(n = n || r)]) ? (r = s) : (u = document.getElementById(r));
                                        else if (e.fn && !v.rTmpl.test(r))
                                            try {
                                                u = e(r, document)[0];
                                            } catch (t) {}
                                    u &&
                                        ("SCRIPT" !== u.tagName && mt(r + ": Use script block, not " + u.tagName),
                                        i
                                            ? (r = u.innerHTML)
                                            : ((a = u.getAttribute("data-jsv-tmpl")) && ("jsvTmpl" !== a ? ((r = f[a]), delete f[a]) : e.fn && (r = e.data(u).jsvTmpl)),
                                              (a && r) || ((n = n || (e.fn ? "jsvTmpl" : r)), (r = t(n, u.innerHTML, o, i))),
                                              (r.tmplName = n = n || a),
                                              "jsvTmpl" !== n && (f[n] = r),
                                              u.setAttribute("data-jsv-tmpl", n),
                                              e.fn && e.data(u, "jsvTmpl", r))),
                                        (u = void 0);
                                } else r.fn || (r = void 0);
                                return r;
                            }
                            ...
                            if (void 0 !== l)
                                return (
                                    l.render || r.render ? l.tmpls && (c = l) : ((r = ft(l, i)), bt(l.replace(O, "\\$&"), r)),
                                    c ||
                                        (function (t) {
                                            var e, n, r;
                    ...
                    tag: {
                        compile: function (t, e, n) {
                            ...
                            if ((o = e.baseTag)) for (i in ((e.flow = !!e.flow), (o = "" + o === o ? (n && n.tags[o]) || g[o] : o) || mt('baseTag: "' + e.baseTag + '" not found'), (a = tt(a, o)), e)) a[i] = G(o[i], e[i]);
                            else a = tt(a, e);
                    ...
                    viewModel: {
                        compile: function (t, n) {
                            var r,
                                ...
                                f = n.extend,
                                p = n.id,
                                d = e.extend({ _is: t || "unnamed", unmap: j, merge: w }, f),
                                g = "",
                                v = "",
                                h = s ? s.length : 0,
                                m = e.observable,
                            ...
                            function _(t, e) {
                                for (var n, r, o, i, u, c = 0; c < h; c++)
                                    (n = void 0), (o = s[c]) + "" !== o && ((o = (n = o).getter), (u = n.parentRef)), void 0 === (i = t[o]) && n && void 0 !== (r = n.defaultVal) && (i = ct(r, t)), e(i, n && a[n.type], o, u);
                            }
                            function w(t, e, n) {
                                ...
                                (y.map = function (e) {
                                    ...
                                    if (e) {
                                        for (
                                            ...
                                            if (((o = f[a]), (i = s[a].parentRef) && o && o.unmap))
                                                if (l(o)) for (n = o.length; n--; ) lt(o[n], i, c);
                                                else lt(o, i, c);
            ...
            function ot(n, r, o) {
                ...
                if (n) {
                    ...
                    if (
                        ((!k && g.tagCtx) || g.linked) &&
                        ((s && s._cxp) ||
                            ((g = g.tagCtx || c(s) ? g : (!(g = g.scope || g).isTop && g.ctx.tag) || g),
                            void 0 !== s && g.tagCtx && (g = g.tagCtx.view.scope),
                            (m = g._ocps),
                            ((s = (m && m.hasOwnProperty(n) && m[n]) || s) && s._cxp) ||
                                (!o && !h) ||
                                (((m || (g._ocps = g._ocps || {}))[n] = s = [{ _ocp: s, _vw: f, _key: n }]),
                                (s._cxp = {
                                    path: "_ocp",
                                    ind: 0,
            ...
            function it(t, e) {
                ...
                if (u) {
                    ...
                    if (((n = (a = a || [0]).length), (l(u) && u.length === n) || ((u = [u]), (a = [0]), (n = 1)), e)) i = u;
                    else for (; n--; ) +(r = a[n]) === r && (i[r] = u[n]);
                }
                return i;
            }
            function at(t, e) {
            ...
            function ut(t, e, n, r, o, i, a, s) {
                ...
                (this.content = s),
                    ...
                    (this.data = r),
                    (this.tmpl = o),
                    (l = this._ = { key: 0, useKey: f ? 0 : 1, id: "" + q++, onRender: a, bnds: {} }),
                    (this.linked = !!a),
                    (this.type = e || "top"),
                    ...
                    (this.parent = n)
                        ? ((this.root = n.root || this),
                          ...
                          (c = n._),
                          (this.isTop = c.scp),
                          (this.scope = ((!t.tag || t.tag === n.ctx.tag) && !this.isTop && n.scope) || this),
                          c.useKey ? ((u[(l.key = "_" + c.useKey++)] = this), (this.index = J), (this.getIndex = et)) : u.length === (l.key = this.index = i) ? u.push(this) : u.splice(i, 0, this),
                          (this.ctx = t || n.ctx))
                        : e && (this.root = this);
            }
            function ct(t, e) {
            ...
            function ft(t, n) {
                var r,
                    o = m._wm || {},
                    i = { tmpls: [], links: {}, bnds: [], _is: "template", render: vt };
            ...
            function pt(t, e) {
                ...
                s[n] = function r(i, a, u) {
                    ...
                    return (
                        i && "" + i !== i && ((u = a), (a = i), (i = void 0)),
                        (f = u ? ("viewModel" === t ? u : (u[n] = u[n] || {})) : r),
                        (c = e.compile),
                        void 0 === a && ((a = c ? i : f[i]), (i = void 0)),
                        null === a ? i && delete f[i] : (c && ((a = c.call(f, i, a, u, 0) || {})._is = t), i && (f[i] = a)),
                        p && p(i, a, u, c),
                        a
                    );
                };
            ...
            function vt(t, e, n, r, i, s) {
                var u,
                    ...
                    _ = "";
                if (
                    (!0 === e ? ((n = e), (e = void 0)) : "object" !== o(e) && (e = void 0),
                    (p = this.tag) ? ((g = this), (d = (y = y || g.view)._getTmpl(p.template || g.tmpl)), arguments.length || (t = p.contentCtx && c(p.contentCtx) ? (t = p.contentCtx(t)) : y)) : (d = this),
                    d)
                ) {
                    if ((!r && t && "view" === t._is && (y = t), y && t === y && (t = y.data), (h = !y), (k = k || h), y || ((e = e || {}).root = t), !k || m.useViews || d.useViews || (y && y !== a))) _ = ht(d, t, e, n, y, i, s, p);
                    else {
                        if ((y ? ((x = y.data), (b = y.index), (y.index = J)) : ((x = (y = a).data), (y.data = t), (y.ctx = e)), l(t) && !n)) for (u = 0, f = t.length; u < f; u++) (y.index = u), (y.data = t[u]), (_ += d.fn(t[u], y, v));
                        else (y.data = t), (_ += d.fn(t, y, v));
                        (y.data = x), (y.index = b);
                    }
                    h && (k = void 0);
                }
            ...
            function ht(t, e, n, r, o, i, a, s) {
                ...
                if (
                    (s &&
                        ((x = s.tagName),
                        (_ = s.tagCtx),
                        (n = n ? kt(n, s.ctx) : s.ctx),
                        t === o.content ? (h = t !== o.ctx._wrp ? o.ctx._wrp : void 0) : t !== _.content ? (t === s.template ? ((h = _.tmpl), (n._wrp = _.content)) : (h = _.content || o.content)) : (h = o.content),
                        !1 === _.props.link && ((n = n || {}).link = !1)),
                    o && ((a = a || o._.onRender), (w = n && !1 === n.link) && o._.nl && (a = void 0), (n = kt(n, o.ctx)), (_ = !s && o.tag ? o.tag.tagCtxs[o.tagElse] : _)),
                    (b = _ && _.props.itemVar) && ("~" !== b[0] && xt("Use itemVar='~myItem'"), (b = b.slice(1))),
                    !0 === i && ((g = !0), (i = 0)),
                    a && s && s._.noVws && (a = void 0),
                    (m = a),
                    !0 === a && ((m = void 0), (a = o._.onRender)),
                    (y = n = t.helpers ? kt(t.helpers, n) : n),
                    l(e) && !r)
                )
                    for ((f = g ? o : (void 0 !== i && o) || new ut(n, "array", o, e, t, i, a, h))._.nl = w, o && o._.useKey && ((f._.bnd = !s || (s._.bnd && s)), (f.tag = s)), u = 0, c = e.length; u < c; u++)
                        (p = new ut(y, "item", f, e[u], t, (i || 0) + u, a, f.content)), b && ((p.ctx = tt({}, y))[b] = v._cp(e[u], "#data", p)), (d = t.fn(e[u], p, v)), (j += f._.onRender ? f._.onRender(d, p) : d);
                else (f = g ? o : new ut(y, x || "data", o, e, t, i, a, h)), b && ((f.ctx = tt({}, y))[b] = v._cp(e, "#data", f)), (f.tag = s), (f._.nl = w), (j += t.fn(e, f, v));
            ...
            function bt(t, e, n, r, o) {
                ...
                if (
                    ...
                    n && (void 0 !== r && (t = t.slice(0, -r.length - 2) + _), (t = b + t + w)),
                    s(m[0] && m[0][2].pop()[0]),
                    t.replace(i, function (i, u, c, p, g, h, x, b, _, w, S, k) {
                        ...
                        (c = c || ((b = b || "#data"), g)),
                            ...
                            x
                                ...
                                : c
                                ? ("else" === c &&
                                      (P.test(b) && xt('For "{{else if expr}}" use "{{else expr}}"'), (A = j[9] && [[]]), (j[10] = t.substring(j[10], k)), (O = j[11] || j[0] || xt("Mismatched: " + i)), (j = m.pop()), (y = j[2]), (J = !0)),
                                  b &&
                                      jt(b.replace(T, " "), A, e, n)
                                          .replace(R, function (t, e, n, r, o, i, a, s) {
                                              return (
                                                  "this:" === r && (i = "undefined"),
                                                  s && (M = M || "@" === s[0]),
                                                  (r = "'" + o + "':"),
                                                  a
                                                      ? (($ += n + i + ","), (V += "'" + s + "',"))
                                                      : n
                                                      ? ((N += r + "j._cp(" + i + ',"' + s + '",view),'), (q += r + "'" + s + "',"))
                                                      : e
                                                      ? (L += i)
                                                      : ("trigger" === o && (U += i), "lateRender" === o && (C = "false" !== s), (F += r + i + ","), (D += r + "'" + s + "',"), (f = f || I.test(o))),
                                                  ""
                                              );
                                          })
                                          .slice(0, -1),
                                  A && A[0] && A.pop(),
                                  (l = [c, p || !!r || f || "", J && [], _t(V || (":" === c ? "'#data'," : ""), D, q), _t($ || (":" === c ? "data," : ""), F, N), L, U, C, M, A || 0]),
                                  y.push(l),
                                  J && (m.push(j), ((j = l)[10] = v), (j[11] = O)))
                                : S && (s(S !== j[0] && S !== j[11] && S, j[0]), (j[10] = t.substring(j[10], k)), (j = m.pop())),
                            s(!j && S),
                            (y = j[2]);
                    }),
                    a(t.length),
                    (v = g[g.length - 1]) && s("" + v !== v && +v[10] === v[10] && v[0]),
                    n)
                ) {
            ...
            function jt(t, e, n, r) {
                var o,
                    ...
                    p = { 0: f },
                    d = 0,
                    g = (n ? n.links : l && (l.links = l.links || {})) || a.tmpl.links,
                    h = 0,
                    m = {},
                    x = {};
                return (
                    "@" === t[0] && (t = t.replace(D, ".")),
                    (c = (t + (n ? " " : "")).replace(v.rPrm, function (a, c, b, w, j, S, k, C, T, E, O, R, P, M, A, I, F, $, N, V, D) {
                        ...
                        if (("[" === (O = O || $ || "") && ((O = "[j._sq("), (z = ")]")), !k || u || s)) {
                            if (l && F && !u && !s && h && ((q = x[h - 1]), D.length - 1 > V - (q || 0))) {
                                if (((q = D.slice(q, V + a.length)), !0 !== L))
                                    if (((U = i || p[h - 1].bd), (J = U[U.length - 1]) && J.prm)) {
                            ...
                            return u
                                ...
                                : (b ? ((x[h] = V++), (f = p[++h] = { bd: [] }), b) : "") +
                                  (N
                                      ? h
                                          ? ""
                                          : ((d = D.slice(d, V)), (o ? ((o = i = !1), "\b") : "\b,") + d + ((d = V + a.length), l && e.push((f.bd = [])), "\b"))
                                      : C
                                      ? (h && xt(t), l && e.pop(), (o = "_" + j), w, (d = V + a.length), l && ((l = f.bd = e[o] = []).skp = !w), j + ":")
                                      : j
                                      ? j
                                            .split("^")
                                            .join(".")
                                            .replace(v.rPath, function (t, n, a, s, u, c, p, d) {
                                                var g = "." === a;
                                                if (
                                                    a &&
                                                    ((j = j.slice(n.length)),
                                                    /^\.?constructor$/.test(d || j) && xt(t),
                                                    g ||
                                                        ((t =
                                                            (E ? (r ? "" : "(ltOb.lt=ltOb.lt||") + "(ob=" : "") +
                                                            (s ? 'view.ctxPrm("' + s + '")' : u ? "view" : "data") +
                                                            (E ? ")===undefined" + (r ? "" : ")") + '?"":view._getOb(ob,"' : "") +
                                                            (d ? (c ? "." + c : s || u ? "" : "." + a) + (p || "") : ((d = s ? "" : u ? c || "" : a), ""))),
                                                        (t = n + ("view.data" === (t += d ? "." + d : "").slice(0, 9) ? t.slice(5) : t) + (E ? (r ? '"' : '",ltOb') + (O ? ",1)" : ")") : ""))),
                                                    l)
                                                ) {
                                                ...
                                                return t;
                                            }) + (O ? ((f = p[++h] = { bd: [] }), (m[h] = z), O) : S)
                                      : S || (I ? ((I = m[h] || I), (m[h] = !1), (f = p[--h]), I + (O ? ((f = p[++h]), (m[h] = z), O) : "")) : R ? (m[h] || xt(t), ",") : c ? "" : ((u = M), (s = A), '"')));
                        }
                        xt(t);
                    })),
                    (!h && c) || xt(t)
            ...
            function St(t, e, n) {
                var r,
                    ...
                    D,
                    q = 0,
                    L = m.useViews || e.useViews || e.tags || e.templates || e.helpers || e.converters,
                    U = "",
                    J = {},
                    B = t.length;
                for (
                    "" + e === e ? ((w = n ? 'data-link="' + e.replace(T, " ").slice(1, -1) + '"' : e), (e = 0)) : ((w = e.tmplName || "unnamed"), e.allowCode && (J.allowCode = !0), e.debug && (J.debug = !0), (p = e.bnds), (_ = e.tmpls)),
                        r = 0;
                    r < B;
                    r++
                )
                    if ("" + (o = t[r]) === o) U += '\n+"' + o + '"';
                        ...
                        if (
                            ((a = o[1]),
                            (k = !n && o[2]),
                            (s = wt(o[3], "params") + "}," + wt((v = o[4]))),
                            ($ = o[6]),
                            (N = o[7]),
                            o[8] ? ((V = "\nvar ob,ltOb={},ctxs="), (D = ";\nctxs.lt=ltOb.lt;\nreturn ctxs;")) : ((V = "\nreturn "), (D = "")),
                            (C = o[10] && o[10].replace(E, "$1")),
                            (P = "else" === i) ? d && d.push(o[9]) : ((I = o[5] || (!1 !== h.debugMode && "undefined")), p && (d = o[9]) && ((d = [d]), (q = p.push(1)))),
                            (L = L || v[1] || v[2] || d || /view.(?!index)/.test(v[0])),
                            (M = ":" === i)
                                ? a && (i = "html" === a ? ">" : a + i)
                                : (k && (((j = ft(C, J)).tmplName = w + "/" + i), (j.useViews = j.useViews || L), St(k, j), (L = j.useViews), _.push(j)),
                                  P || ((S = i), (L = L || (i && (!g[i] || !g[i].flow))), (R = U), (U = "")),
                                  (O = (O = t[r + 1]) && "else" === O[0])),
                            (F = I ? ";\ntry{\nret+=" : "\n+"),
                            (x = ""),
                            (b = ""),
                        ...
                        if (
                            ((U += M
                                ? (n ? (I ? "try{\n" : "") + "return " : F) +
                                  (f ? ((f = void 0), (L = l = !0), y + (A ? ((p[q - 1] = A), q) : "{" + s + "}") + ")") : ">" === i ? ((c = !0), "h(" + v[0] + ")") : (!0, "((v=" + v[0] + ")!=null?v:" + (n ? "null)" : '"")')))
                                : ((u = !0), "\n{view:view,content:false,tmpl:" + (k ? _.length : "false") + "," + s + "},")),
                            S && !O)
                        ) {
            ...
            function Ct(t, n) {
                ...
                if (
                    ...
                    v < 0 && (!p || c(p)) && (t = t.reverse()),
                    t.filter && f && ((t = t.filter(f, n)), n.tag.onFilter && n.tag.onFilter(n)),
                    u.sorted && ((r = p || v < 0 ? t : t.slice()), a.sorted ? e.observable(a.sorted).refresh(r) : (n.map.sorted = r)),
                    (o = s.start),
                    (i = s.end),
                    ((u.start && void 0 === o) || (u.end && void 0 === i)) && (o = i = 0),
                    (isNaN(o) && isNaN(i)) || ((o = +o || 0), (i = void 0 === i || i > t.length ? t.length : +i), (t = t.slice(o, i))),
                    g > 1)
                ) {
            ...
            function Tt(t, n, r) {
                var o = this.jquery && (this[0] || mt("Unknown template")),
            ...
            if (
                ((s = {
                    ...
                    sub: {
                        ...
                        _cnvt: function (t, e, n, r) {
                            ...
                            if (((c = c._bd && c), t || c)) {
                                if (((i = e._lc), (o = i && i.tag), (n.view = e), !o)) {
                                    if (((o = tt(new v._tg(), { _: { bnd: c, unlinked: !0, lt: n.lt }, inline: !i, tagName: ":", convert: t, onArrayChange: !0, flow: !0, tagCtx: n, tagCtxs: [n], _is: "tag" })), (s = n.args.length) > 1))
                                        for (u = o.bindTo = []; s--; ) u.unshift(s);
                        ...
                        _tag: function (t, e, n, r, o, i) {
                            ...
                            void 0 !== i ? ((U += i), (r = i = [{ props: {}, args: [], params: { props: {} } }])) : K && (r = K(e.data, e, v));
                            for (h = r.length; L < h; L++)
                                (y = r[L]),
                                    (C = y.tmpl),
                                    (!J || !J.tag || (L && !J.tag.inline) || u._er || (C && +C === C)) &&
                                        (C && z.tmpls && (y.tmpl = y.content = z.tmpls[C - 1]), (y.index = L), (y.ctxPrm = ot), (y.render = vt), (y.cvtArgs = it), (y.bndArgs = st), (y.view = e), (y.ctx = kt(kt(y.ctx, c && c.ctx), B))),
                                    ...
                                    u
                                        ...
                                        : ((u = new c._ctr()),
                                          ...
                                          (u.parent = g = B && B.tag),
                                          (u.tagCtxs = r),
                                          J && ((u.inline = !1), (J.tag = u)),
                                          (u.linkCtx = J),
                                          (u._.bnd = K || J.fn) ? ((u._.ths = y.params.props.this), (u._.lt = r.lt), (u._.arrVws = {})) : u.dataBoundOnly && mt(t + " must be data-bound:\n{^{" + t + "}}")),
                                    (A = u.dataMap),
                                    (y.tag = u),
                                    A && r && (y.map = r[L].map),
                                    u.flow || ((_ = y.ctx = y.ctx || {}), (f = u.parents = _.parentTags = (B && kt(_.parentTags, B.parentTags)) || {}), g && (f[g.tagName] = g), (f[u.tagName] = _.tag = u), (_.tagCtx = y));
                            if (!(u._er = i)) {
                                for (W(u, r[0]), u.rendering = { rndr: u.rendering }, L = 0; L < h; L++) {
                                    if (((y = u.tagCtx = r[L]), (M = y.props), (u.ctx = y.ctx), !L)) {
                                        if (
                                            (T && (u.init(y, J, u.ctx), (T = void 0)),
                                            y.args.length || !1 === y.argDefault || !1 === u.argDefault || ((y.args = R = [y.view.data]), (y.params.args = ["#data"])),
                                            (j = s("bindTo")),
                                            void 0 !== u.bindTo && (u.bindTo = j),
                                            void 0 !== u.bindFrom ? (u.bindFrom = s("bindFrom")) : u.bindTo && (u.bindFrom = u.bindTo = j),
                                            (S = u.bindFrom || j),
                                            (V = j.length),
                                            (N = S.length),
                                            u._.bnd && (D = u.linkedElement) && ((u.linkedElement = D = l(D) ? D : [D]), V !== D.length && mt("linkedElement not same length as bindTo")),
                                            (D = u.linkedCtxParam) && ((u.linkedCtxParam = D = l(D) ? D : [D]), N !== D.length && mt("linkedCtxParam not same length as bindFrom/bindTo")),
                                            S)
                                        )
                                            for (u._.fromIndex = {}, u._.toIndex = {}, x = N; x--; ) for ($ = S[x], m = V; m--; ) $ === j[m] && ((u._.fromIndex[m] = x), (u._.toIndex[x] = m));
                                        J && (J.attr = u.attr = J.attr || u.attr || J._dfAt), (d = u.attr), (u._.noVws = d && "html" !== d);
                                    }
                                    if (((R = u.cvtArgs(L)), u.linkedCtxParam))
                                        for (P = u.cvtArgs(L, 1), m = N, q = u.constructor.prototype.ctx; m--; )
                                            (w = u.linkedCtxParam[m]) &&
                                                (($ = S[m]), (k = P[m]), (y.ctx[w] = v._cp(q && void 0 === k ? q[w] : k, void 0 !== k && at(y.params, $), y.view, u._.bnd && { tag: u, cvt: u.convert, ind: m, tagElse: L })));
                                    (E = M.dataMap || A) && (R.length || M.dataMap) && (((O = y.map) && O.src === R[0] && !o) || (O && O.src && O.unmap(), E.map(R[0], y, O, !u._.bnd), (O = y.map)), (R = [O.tgt])),
                                        (b = void 0),
                                        u.render &&
                                            ((b = u.render.apply(u, R)),
                                            e.linked &&
                                                b &&
                                                !F.test(b) &&
                                                (((n = { links: [] }).render = n.fn = function () {
                                                    return b;
                                                }),
                                                (b = ht(n, e.data, void 0, !0, e, void 0, void 0, u)))),
                                        R.length || (R = [e]),
                                        void 0 === b && ((I = R[0]), u.contentCtx && (I = !0 === u.contentCtx ? e : u.contentCtx(I)), (b = y.render(I, !0) || (o ? void 0 : ""))),
                                        (U = U ? U + (b || "") : void 0 !== b ? "" + b : void 0);
                                }
                    ...
                    settings: {
                        delimiters: function t(e, n, r) {
                            ...
                            return (
                                ...
                                (_ = n[0]),
                                (w = n[1]),
                                (h.delimiters = [b + y, _ + w, j]),
                                (e = "\\" + b + "(\\" + j + ")?\\" + y),
                                (n = "\\" + _ + "\\" + w),
                                (i = "(?:(\\w+(?=[\\/\\s\\" + _ + "]))|(\\w+)?(:)|(>)|(\\*))\\s*((?:[^\\" + _ + "]|\\" + _ + "(?!\\" + w + "))*?)"),
                                (v.rTag = "(?:" + i + ")"),
                                (i = new RegExp("(?:" + e + i + "(\\/)?|\\" + b + "(\\" + j + ")?\\" + y + "(?:(?:\\/(\\w+))\\s*|!--[\\s\\S]*?--))" + n, "g")),
                                (v.rTmpl = new RegExp("^\\s|\\s$|<.*>|([^\\\\]|^)[{}]|" + e + ".*" + n)),
                                x
                            );
                        },
                        advanced: function (t) {
                ...
                ((Y.prototype = new Error()).constructor = Y),
                (et.depends = function () {
                ...
                (ut.prototype = {
                    get: function (t, e) {
                        ...
                        else if (e) for (; a && !i; ) (i = a.type === e ? a : void 0), (a = a.parent);
                        else i = a.parent;
                        return i || void 0;
                    },
                    getIndex: nt,
                ...
                (x.debugMode = function (t) {
                    ...
                    (m = h.advanced = { useViews: !1, _jsv: !1 }),
                    g({
                        if: {
                            render: function (t) {
                                var e = this.tagCtx;
                            ...
                            setDataMap: function (t) {
                                for (var e, n, r, o = t.length; o--; )
                                    (n = (e = t[o]).props),
                                        ...
                                        (n.dataMap =
                                            !1 !== e.argDefault && l(e.args[0]) && (r.sort || r.start || r.end || r.step || r.filter || r.reverse || n.sort || n.start || n.end || n.step || n.filter || n.reverse) && this.sortDataMap);
                            },
                            flow: !0,
                        },
                        props: {
                            baseTag: "for",
                            dataMap: gt(function (t, n) {
                                var r,
                                    i,
                                    a = n.map,
                                    s = a && a.propsArr;
                                if (!s) {
                                    if (((s = []), "object" === o(t) || c(t))) for (r in t) (i = t[r]), r === u || !t.hasOwnProperty(r) || (n.props.noFunctions && e.isFunction(i)) || s.push({ key: r, prop: i });
                    ...
                    "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1)[d] || 2 != "ab".split(/(?:ab)*/)[d] || 4 != ".".split(/(.?)(.?)/)[d] || ".".split(/()()/)[d] > 1 || "".split(/.?/)[d]
                        ? function (t, e) {
                              ...
                              for (
                                  ...
                                  (i = c.call(v, o)) && !((a = v.lastIndex) > f && (u.push(o.slice(f, i.index)), i[d] > 1 && i.index < o[d] && p.apply(u, i.slice(1)), (s = i[0][d]), (f = a), u[d] >= g));

                              )
                                  v.lastIndex === i.index && v.lastIndex++;
                              return f === o[d] ? (!s && v.test("")) || u.push("") : u.push(o.slice(f)), u[d] > g ? u.slice(0, g) : u;
                          }
                        : "0".split(void 0, 0)[d]
                        ? function (t, e) {
                ...
                [
                    ...
                    function (t, e) {
                        ...
                        for (var y = 0, _ = 0, w = []; _ < p.length; ) {
                            ...
                            var j,
                                S = u(x, g ? p : p.slice(_));
                            if (null === S || (j = f(s(x.lastIndex + (g ? 0 : _)), p.length)) === y) _ = a(p, _, h);
                            else {
