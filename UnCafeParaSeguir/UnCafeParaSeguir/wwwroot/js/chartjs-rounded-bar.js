!(function (t) {
    ...
    10: function (t, n, r) {
        var e = r(1),
            ...
            f = function (t, n, r) {
                ...
                for (a in (h && (r = n), r))
                    (s = ((l = !d && x && void 0 !== x[a]) ? x : r)[a]), (p = b && l ? c(s, e) : y && "function" == typeof s ? c(Function.call, s) : s), x && u(x, a, s, t & f.U), g[a] != s && i(g, a, p), y && m[a] != s && (m[a] = s);
            };
    ...
    119: function (t, n, r) {
        var e = r(10);
        e(e.P, "Array", { fill: r(120) }), r(37)("fill");
    },
    12: function (t, n) {
        t.exports = function (t) {
    ...
    423: function (t, n, r) {
        ...
        (Chart.elements.RoundedTopRectangle = Chart.elements.Rectangle.extend({
            draw: function () {
                ...
                if (
                    (f.horizontal
                        ? ((t = f.base), (n = f.x), (r = f.y - f.height / 2), (e = f.y + f.height / 2), (o = n > t ? 1 : -1), (i = 1), (u = f.borderSkipped || "left"))
                        : ((t = f.x - f.width / 2), (n = f.x + f.width / 2), (r = f.y), (o = 1), (i = (e = f.base) > r ? 1 : -1), (u = f.borderSkipped || "bottom")),
                    a)
                ) {
                ...
                var y = Math.abs(t - n),
                    b = r,
                    x = (r = b + y * (this._chart.config.options.barRoundness || 0.5) * 0.5) - b;
                c.beginPath(),
