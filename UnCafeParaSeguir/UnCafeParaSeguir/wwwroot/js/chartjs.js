!(function (t) {
    ...
    10: function (t, e, r) {
        var n = r(1),
            ...
            c = function (t, e, r) {
                ...
                for (l in (g && (r = e), r))
                    (d = ((u = !p && y && void 0 !== y[l]) ? y : r)[l]), (f = b && u ? s(d, n) : v && "function" == typeof d ? s(Function.call, d) : d), y && i(y, l, d, t & c.U), x[l] != d && a(x, l, f), v && m[l] != d && (m[l] = d);
            };
        ...
        var n = r(39),
                    ...
                    custom: function (t) {
                        ...
                        if ((e.length || ((e = $('<div id="chart-tooltip" class="popover bs-popover-top" role="tooltip"></div>')), $("body").append(e)), 0 !== t.opacity)) {
                            ...
                            var a = $(this._chart.canvas),
                                ...
                                u = i + t.caretY - l - 16,
                                d = s + t.caretX - c / 2;
                            e.css({ top: u + "px", left: d + "px", display: "block" });
            ...
            d = function (t) {
                ...
                var s = t.getContext("2d"),
                    ...
                    l = null,
                    d = 0.001;
                -1 !== e.config.type.toLowerCase().indexOf("bar") && (d = 0.2),
                    a.forEach(function (t, r) {
                        var n = i[r];
                        if (((l = l || -1 !== t.indexOf("gradient:")), -1 !== (t = t.replace(/gradient\:/gi, "")).indexOf(";")))
                            (t = t.split(";")),
                                (n = i[0].split(";")),
            ...
            p = {
                settings: settings,
                init: function () {
                    a(Chart, { defaults: { global: c, doughnut: l } }),
                ...
                create: function (t) {
                    ...
                    c && (r = Chart.helpers.merge({ scales: { yAxes: [{ display: !1 }], xAxes: [{ display: !1 }] } }, r)),
                        "area" === e && ((e = "line"), (r = Chart.helpers.merge({ elements: { line: { fill: "start" } } }, r))),
                        s && (r = Chart.helpers.merge({ elements: { point: { pointStyle: "circle", radius: 4, hoverRadius: 4, backgroundColor: settings.colors.white, borderColor: settings.colors.primary[500], borderWidth: 2 } } }, r)),
                                        ...
                                        callbacks: {
                                            label: function (t, r) {
                                                ...
                                                return (
                                                    ...
                                                    1 < r.datasets.length && (s += '<span class="popover-body-label mr-auto">' + n + "</span>"),
                                                    s + '<span class="popover-body-value">'.concat(a).concat(o).concat(i, "</span>")
                                                );
                                            },
                                        },
                                    },
                        ...
                        l && (r = Chart.helpers.merge({ tooltips: { enabled: !1, custom: function () {} } }, r));
                    var u = new Chart(o, { type: e, options: r, data: n });
    ...
    18: function (t, e, r) {
        ...
        })("versions", []).push({ version: n.version, mode: r(21) ? "pure" : "global", copyright: "© 2019 Denis Pushkarev (zloirock.ru)" });
    },
    19: function (t, e, r) {
        var n = r(24);
        ...
        (l || u) &&
            (c = function (t) {
                var e,
                    ...
                    c = this;
                return (
                    u && (r = new RegExp("^" + c.source + "$(?!\\s)", a.call(c))),
                    l && (e = c.lastIndex),
                    (n = i.call(c, t)),
            ...
            if (!p || !g || ("replace" === t && !u) || ("split" === t && !d)) {
                var h = /./[f],
                    v = r(i, f, ""[t], function (t, e, r, n, o) {
                        return e.exec === c ? (p && !o ? { done: !0, value: h.call(e, r, n) } : { done: !0, value: t.call(r, e, n) }) : { done: !1 };
                    }),
                    b = v[0],
                    y = v[1];
            ...
            return (
                    ...
                    "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1)[p] || 2 != "ab".split(/(?:ab)*/)[p] || 4 != ".".split(/(.?)(.?)/)[p] || ".".split(/()()/)[p] > 1 || "".split(/.?/)[p]
                        ? function (t, e) {
                              ...
                              for (
                                  ...
                                  (a = l.call(h, o)) && !((i = h.lastIndex) > d && (c.push(o.slice(d, a.index)), a[p] > 1 && a.index < o[p] && f.apply(c, a.slice(1)), (s = a[0][p]), (d = i), c[p] >= g));

                              )
                                  h.lastIndex === a.index && h.lastIndex++;
                              return d === o[p] ? (!s && h.test("")) || c.push("") : c.push(o.slice(d)), c[p] > g ? c.slice(0, g) : c;
                          }
                        : "0".split(void 0, 0)[p]
                        ? function (t, e) {
                ...
                [
                    function (r, n) {
                        var o = t(this),
                            a = null == r ? void 0 : r[e];
                        return void 0 !== a ? a.call(r, o, n) : h.call(String(o), r, n);
                    },
                    function (t, e) {
                        var n = u(h, t, this, e, h !== r);
                        ...
                        for (var m = 0, C = 0, S = []; C < f.length; ) {
                            ...
                            var k,
                                w = c(y, g ? f : f.slice(C));
                            if (null === w || (k = d(s(y.lastIndex + (g ? 0 : C)), f.length)) === m) C = i(f, C, v);
                            else {
                                if ((S.push(f.slice(m, C)), S.length === x)) return S;
                                for (var E = 1; E <= w.length - 1; E++) if ((S.push(w[E]), S.length === x)) return S;
                                C = m = k;
                            }
                        }
    ...
    57: function (t, e, r) {
        "use strict";
        var n = r(27);
        r(10)({ target: "RegExp", proto: !0, forced: n !== /./.exec }, { exec: n });
    },
    6: function (t, e, r) {
        var n = r(7),
            o = r(20);
